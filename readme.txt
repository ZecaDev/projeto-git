...
git branch - aparece todas branch do repositório
...
git pull origin[repositório remoto] main[repositório loca] - recebe commits do repositório remoto
...
rm - remove apenas arquivo

rmdir - remove o diretório que esteja vazio

rm -r - remove o diretorio que tenha arquivos dentro

mv - serve para renomear ou mover o arquivo
mv 'nome' 'nome-novo'
mv 'arquivo-mover' 'pasta/'

; - pode usar para colocar mais de um código na mesma linha
